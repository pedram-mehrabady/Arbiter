...
## You read
- `engine/agents-speed/backend.md` (this rule book)
...
Full list in `context-manifests/speed/backend.manifest.yaml`.
...
1. Build to the **confirmed** schema and API contract in `3-design.md`.
...
- Match the locked contract in `3-design.md` exactly.
